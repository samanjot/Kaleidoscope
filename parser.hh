...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // definition
      char dummy2[sizeof (FunctionAST*)];

      // pair
      char dummy3[sizeof (Pair)];

      // argument
      char dummy4[sizeof (ProtoArgument)];
      ...
      // varlist
      char dummy10[sizeof (std::vector<Pair>)];

      // idseq
      char dummy11[sizeof (std::vector<ProtoArgument>)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_proto = 41,                            // proto
        S_idseq = 42,                            // idseq
        S_argument = 43,                         // argument
        S_exp = 44,                              // exp
        S_assignment = 45,                       // assignment
        S_unaryexp = 46,                         // unaryexp
        S_varexp = 47,                           // varexp
        S_varlist = 48,                          // varlist
        S_pair = 49,                             // pair
        S_optarray = 50,                         // optarray
        S_idexp = 51,                            // idexp
        S_optexp = 52,                           // optexp
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_argument: // argument
        value.move< ProtoArgument > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_idseq: // idseq
        value.move< std::vector<ProtoArgument> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Pair&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Pair& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ProtoArgument&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ProtoArgument& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<Pair>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<Pair>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<ProtoArgument>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<ProtoArgument>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_argument: // argument
        value.template destroy< ProtoArgument > ();
        break;
      ...
      case symbol_kind::S_idseq: // idseq
        value.template destroy< std::vector<ProtoArgument> > ();
        break;
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_MULTIEXP (location_type l)
      {
        return symbol_type (token::TOK_MULTIEXP, std::move (l));
      }
#else
      static
      symbol_type
      make_MULTIEXP (const location_type& l)
      {
        return symbol_type (token::TOK_MULTIEXP, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LCBRACKET (location_type l)
      {
        return symbol_type (token::TOK_LCBRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_LCBRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_LCBRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RCBRACKET (location_type l)
      {
        return symbol_type (token::TOK_RCBRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_RCBRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_RCBRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LSBRACKET (location_type l)
      {
        return symbol_type (token::TOK_LSBRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_LSBRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_LSBRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RSBRACKET (location_type l)
      {
        return symbol_type (token::TOK_RSBRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_RSBRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_RSBRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_argument: // argument
        value.copy< ProtoArgument > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_idseq: // idseq
        value.copy< std::vector<ProtoArgument> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_argument: // argument
        value.move< ProtoArgument > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_idseq: // idseq
        value.move< std::vector<ProtoArgument> > (YY_MOVE (s.value));
        break;
